...
public class RunwayTest {
	...
	private static List<Runway> bangaloreRunways() {
		return Collections.singletonList(
				Runway.builder().id(1).airportId(bangalore().getId()).countryId(india().getId()).build());
	}
	...
	public void testFetchRunwaysForAirport() throws Exception {
		...
		assertThat(runwayService.fetchRunwaysForAirports(Collections.singletonList(bangalore())))
				.isEqualTo(bangaloreRunways());
		...
		assertThat(runwayService.fetchRunwaysForAirports(Arrays.asList(bangalore(), amsterdam())))
				.isEqualTo(bangaloreRunways());
	}
	...
	public void testFetchRunwaysForCountry() throws Exception {
		...
		assertThat(runwayService.fetchRunwaysForCountries(Collections.singletonList(india())))
				.isEqualTo(bangaloreRunways());
		...
		assertThat(runwayService.fetchRunwaysForCountries(Arrays.asList(india(), netherlands())))
				.isEqualTo(bangaloreRunways());
	}
