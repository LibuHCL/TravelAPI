...
This project is a simple application which provides solution to the lunatech assignment

Assessment
Download three CSV files, one for airports, one for runways and another for countries.
...
The application is been enabled with 

	Spring Actuator for monitoring.
	Spring Caffeine for caching.
	Swagger UI for documenting the endpoint services.
